...
export class UserController {
    ...
    @ApiResponse({ status: 400, description: 'User name is taken'})
    ...
    @ApiResponse({ status: 200, description: 'User data changed'})
    @ApiResponse({ status: 404, description: "User doesn't exist!"})
    @ApiResponse({ status: 400, description: "User email already used!"})
    @ApiResponse({ status: 500, description: 'Internal server error'})
    changeUserEmail(
    ...
    @ApiResponse({ status: 200, description: 'User data changed'})
    @ApiResponse({ status: 404, description: "User doesn't exist!"})
    @ApiResponse({ status: 400, description: "Name/Email is taken!"})
    @ApiResponse({ status: 500, description: 'Internal server error'})
    changeUserdata(
        @Query('userid') userid: string,
        @Body() data:UserdataUpdateDto,
    ):Promise<HttpException>{
